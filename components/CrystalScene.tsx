...
function CrystalWorld({
  ...
  useFrame((state, delta) => {
    ...
    rig.current.rotation.y = THREE.MathUtils.damp(
      ...
      pointer.current.x * 0.1 + state.clock.elapsedTime * 0.01,
      2.5,
      delta
    );
  });
  ...
  return (
    <>
      ...
      <group ref={rig}>
        <Crystal
          position={[-4.1, 0.55, -1.5]}
          rotation={[0.12, 0.25, -0.35]}
          scale={1.36}
        />
        <Crystal
          position={[4.25, 0.2, -1.2]}
          rotation={[-0.1, -0.48, 0.42]}
          scale={1.15}
        />
        <Crystal
          position={[1.75, -3.15, -2.8]}
          rotation={[1.1, 0.15, 0.5]}
          scale={0.86}
        />
      </group>
